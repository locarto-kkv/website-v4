    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-md py-4 px-6 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <span className="ml-4 bg-orange-100 text-primary text-sm font-medium px-3 py-1 rounded-full">Customer Dashboard</span>
        </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md dashboard-card border-l-4 border-primary">
            <div className="flex justify-between items-center">
              <div>
                ...
                <h3 className="text-3xl font-bold mt-2">{wishlistItems.length}</h3>
              </div>
              <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center border-b pb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">Delivered on May 15, 2023</p>
                  </div>
                  <div className="text-right">
                    <p className="font-medium">$89.99</p>
                    <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Delivered</span>
                  </div>
                </div>
                ...
                <div className="flex items-center border-b pb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">Shipped on May 10, 2023</p>
                  </div>
                  <div className="text-right">
                    <p className="font-medium">$149.99</p>
                    <span className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Shipped</span>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-right">
                    ...
                    <span className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-full">Processing</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-bold text-secondary mb-6">Leave a Review</h2>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-gray-200 rounded-lg mr-4"></div>
                <div>
                  <h3 className="font-medium">Wireless Headphones</h3>
                  <p className="text-gray-600 text-sm">Order #ORD-7841 • Delivered</p>
                </div>
              </div>
              ...
              <form onSubmit={handleReviewSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="flex text-2xl text-yellow-400">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <i 
                        key={star}
                        className={`fas fa-star cursor-pointer hover:text-yellow-500 ${star <= reviewForm.rating ? 'text-yellow-400' : 'text-gray-300'}`}
                ...
                <button type="submit" className="bg-primary text-white py-3 px-6 rounded-lg font-bold hover:bg-orange-600 transition">Submit Review</button>
              </form>
            </div>
          </div>
          ...
          <div>
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              <h2 className="text-xl font-bold text-secondary mb-6">Shopping Cart</h2>
              <div className="space-y-4">
                {cartItems.map(item => (
                  <div key={item.id} className="flex items-center border-b pb-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="w-10 h-8 flex items-center justify-center border-y">{item.quantity}</span>
                      <button 
              ...
              <div className="mt-6 pt-4 border-t">
                ...
                <button className="w-full bg-primary text-white py-3 rounded-lg font-bold hover:bg-orange-600 transition mt-6">Proceed to Checkout</button>
              </div>
            </div>
            
            <div className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-bold text-secondary mb-6">Wishlist</h2>
              <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mt-6">
              <h2 className="text-xl font-bold text-secondary mb-6">Recommended for You</h2>
