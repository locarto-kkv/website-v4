...
const DiscoverPage = () => {
  ...
  return (
    <div
      className="font-sans flex flex-col text-[#0D1539] min-h-screen bg-white relative overflow-hidden"
    >
      {/* Background Decorative Assets - Fewer for discover page */}
      ...
      <main className="flex-1 pt-24 pb-16 px-4 md:px-8 relative z-10">
        ...
        <div className="mb-12 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg 
                        ...
                        max-w-3xl mx-auto h-56 md:h-72 relative animate-[fadeIn_0.8s_ease-in]">
          ...
          <div className="max-w-xl mx-auto">
            <div className="flex items-stretch border-2 border-[#0D1539]/30 rounded-full overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:border-[#0D1539]/50">
              ...
              <button 
                ...
                className="px-4 py-2 text-sm font-medium bg-[#0D1539] text-white hover:bg-[#1A244C] transition-all duration-300 whitespace-nowrap rounded-full hover:scale-105"
              >
