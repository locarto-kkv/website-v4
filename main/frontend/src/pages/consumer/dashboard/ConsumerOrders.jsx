                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-3 md:mt-4 pt-3 md:pt-4 border-t border-gray-200">
                    ...
                    {order.order_status === "delivered" && (
                      <button className="flex-1 px-3 py-2 md:px-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition-all">
                        Write Review
                      </button>
                    )}
                  </div>
