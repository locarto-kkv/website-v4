      ...
      products: [
        {
          ...
          rating: 4.8,
          stock: 15,
          image: "https://via.placeholder.com/300/10B981/ffffff?text=Dumbbells",
        },
        {
          id: 2,
          name: "Treadmill Home",
          ...
          rating: 4.9,
          stock: 5,
          image: "https://via.placeholder.com/300/059669/ffffff?text=Treadmill",
        },
        {
          id: 3,
          name: "Exercise Ball",
          ...
          rating: 4.6,
          stock: 25,
          image: "https://via.placeholder.com/300/047857/ffffff?text=Ball",
        },
        {
          id: 4,
          name: "Kettlebell",
          ...
          stock: 20,
          image:
            "https://via.placeholder.com/300/065f46/ffffff?text=Kettlebell",
        },
        {
          id: 5,
          name: "Jump Rope",
          ...
          rating: 4.5,
          stock: 45,
          image: "https://via.placeholder.com/300/064e3b/ffffff?text=Rope",
        },
        {
          id: 6,
          name: "Foam Roller",
          ...
          rating: 4.8,
          stock: 30,
          image: "https://via.placeholder.com/300/10B981/ffffff?text=Roller",
        },
      ],
    },
      ...
      products: [
        {
          ...
          rating: 4.9,
          stock: 8,
          image: "https://via.placeholder.com/300/F59E0B/ffffff?text=Handbag",
        },
        {
          id: 2,
          name: "Leather Jacket",
          ...
          rating: 4.8,
          stock: 12,
          image: "https://via.placeholder.com/300/D97706/ffffff?text=Jacket",
        },
        {
          id: 3,
          name: "Sunglasses",
          ...
          stock: 20,
          image:
            "https://via.placeholder.com/300/B45309/ffffff?text=Sunglasses",
        },
        {
          id: 4,
          name: "Silk Scarf",
          ...
          rating: 4.6,
          stock: 25,
          image: "https://via.placeholder.com/300/92400E/ffffff?text=Scarf",
        },
        {
          id: 5,
          ...
          rating: 4.8,
          stock: 15,
          image: "https://via.placeholder.com/300/78350F/ffffff?text=Sneakers",
        },
        {
          id: 6,
          name: "Belt Designer",
          ...
          rating: 4.5,
          stock: 30,
          image: "https://via.placeholder.com/300/F59E0B/ffffff?text=Belt",
        },
      ],
    },
    "casa-living": {
      ...
      products: [
        {
          ...
          rating: 4.8,
          stock: 18,
          image: "https://via.placeholder.com/300/F59E0B/ffffff?text=Vase",
        },
        {
          id: 2,
          ...
          rating: 4.7,
          stock: 30,
          image: "https://via.placeholder.com/300/D97706/ffffff?text=Pillows",
        },
        {
          id: 3,
          ...
          rating: 4.9,
          stock: 10,
          image: "https://via.placeholder.com/300/B45309/ffffff?text=Canvas",
        },
        {
          id: 4,
          name: "Table Lamp",
          ...
          rating: 4.6,
          stock: 22,
          image: "https://via.placeholder.com/300/92400E/ffffff?text=Lamp",
        },
        {
          id: 5,
          name: "Rug Modern",
          ...
          rating: 4.8,
          stock: 8,
          image: "https://via.placeholder.com/300/78350F/ffffff?text=Rug",
        },
        {
          id: 6,
          ...
          rating: 4.5,
          stock: 35,
          image: "https://via.placeholder.com/300/F59E0B/ffffff?text=Frames",
        },
      ],
    },
      ...
      products: [
        {
          ...
          rating: 4.9,
          stock: 5,
          image: "https://via.placeholder.com/300/EF4444/ffffff?text=Necklace",
        },
        {
          id: 2,
          name: "Diamond Ring",
          ...
          rating: 5.0,
          stock: 3,
          image: "https://via.placeholder.com/300/DC2626/ffffff?text=Ring",
        },
        {
          id: 3,
          name: "Pearl Earrings",
          ...
          rating: 4.8,
          stock: 12,
          image: "https://via.placeholder.com/300/B91C1C/ffffff?text=Earrings",
        },
        {
          id: 4,
          ...
          rating: 4.7,
          stock: 15,
          image: "https://via.placeholder.com/300/991B1B/ffffff?text=Bracelet",
        },
        {
          id: 5,
          name: "Gold Chain",
          ...
          rating: 4.8,
          stock: 8,
          image: "https://via.placeholder.com/300/7F1D1D/ffffff?text=Chain",
        },
        {
          id: 6,
          ...
          rating: 4.9,
          stock: 10,
          image: "https://via.placeholder.com/300/EF4444/ffffff?text=Pendant",
        },
      ],
    },
    "timepiece-gallery": {
      ...
      products: [
        {
          ...
          rating: 5.0,
          stock: 2,
          image: "https://via.placeholder.com/300/EF4444/ffffff?text=Rolex",
        },
        {
          id: 2,
          ...
          rating: 4.9,
          stock: 3,
          image: "https://via.placeholder.com/300/DC2626/ffffff?text=Omega",
        },
        {
          id: 3,
          name: "Tag Heuer Sport",
          type: "Sports Watch",
          price: "$3299.99",
          rating: 4.8,
          stock: 5,
          image: "https://via.placeholder.com/300/B91C1C/ffffff?text=Tag",
        },
        {
          id: 4,
          ...
          rating: 4.7,
          stock: 10,
          image: "https://via.placeholder.com/300/991B1B/ffffff?text=Seiko",
        },
        {
          id: 5,
          name: "Casio G-Shock",
          ...
          rating: 4.6,
          stock: 20,
          image: "https://via.placeholder.com/300/7F1D1D/ffffff?text=Casio",
        },
        {
          id: 6,
          ...
          rating: 4.5,
          stock: 15,
          image: "https://via.placeholder.com/300/EF4444/ffffff?text=Fossil",
        },
      ],
    },
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background: `radial-gradient(circle, ${currentShop.color}, transparent)`,
          }}
        ></div>
        <div
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            <div className="bg-white/20 backdrop-blur-lg rounded-2xl p-3 shadow-2xl border border-white/30">
              <div className="w-20 h-20 bg-white/30 rounded-xl flex items-center justify-center overflow-hidden">
                <i
                  className={`${currentShop.icon} text-3xl text-white drop-shadow-lg`}
                ></i>
              </div>
            </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between pt-3 border-t border-white/10">
                      ...
                      <button
                        ...
                        style={{
                          background: `linear-gradient(135deg, ${currentShop.color}, ${currentShop.color}dd)`,
                        }}
                      >
