      ...
      <main id="home" className="active">
        ...
        <section className="hero-gradient text-white py-16 md:py-24 px-6">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-2xl mx-auto">
              Your favorite local marketplace for unique products and services
            </p>
              ...
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i
                      className={`fas fa-${
                        ["laptop", "tshirt", "home", "heartbeat"][i]
        ...
        <section id="how-it-works" className="py-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Simple steps to buy or sell locally
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[1, 2, 3].map((step) => (
                <div
                  key={step}
                  className="text-center bg-white p-8 rounded-xl shadow-md card-hover"
                >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {["Sarah Johnson", "Michael Chen", "Emma Rodriguez"].map(
                (name, i) => (
                  <div
                    key={i}
                    className="bg-white p-6 rounded-xl shadow-md testimonial-card"
                  >
