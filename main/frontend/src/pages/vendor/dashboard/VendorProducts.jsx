...
const VendorProducts = () => {
  ...
  const getStockStatus = (quantity) => {
    // Renamed from stock to quantity
    ...
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xs sm:max-w-md md:max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
            {" "}
            {/* Responsive max-w and flex col */}
            {/* Modal Header */}
                          ...
                          <img
                            src={
                              ...
                              (image.file
                                ...
                                : "placeholder.png")
                            } // Handle both existing URL and new file
