...
const VendorAnalytics = () => {
  ...
  const { products, vendor, analyticData } = useVendorDataStore();
  ...
  const generateChartPoints = (data) => {
    ...
    return data //
      .map((item, index) => {
        ...
        const x =
          padding +
          (index * (width - 2 * padding)) / Math.max(1, data.length - 1); // Avoid division by zero
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
          ...
          {Object.entries(tabConfig).map(
            (
              ...
              <button //
                ...
                className={`flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-4 font-semibold transition-all duration-200 min-w-0 flex-shrink-0 border-b-2 ${
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3">
                    ...
                    >
                      <i
                        className={`${metric.icon} text-white text-base sm:text-lg`}
                      ></i>{" "}
                      {/* Adjusted size */}
                    </div>
                    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6">
          {" "}
          {/* Adjusted padding */}
          ...
          <div className="relative h-64 sm:h-80 w-full bg-gradient-to-t from-gray-50 to-transparent rounded-xl p-2 sm:p-4">
            {" "}
          ...
          {currentData.chartData && currentData.chartData.length > 0 && (
            <div className="grid grid-cols-6 lg:grid-cols-12 gap-1 sm:gap-2 mt-4 text-[10px] sm:text-xs font-medium text-gray-500">
              {" "}
              ...
              {timePeriod === "month" &&
                currentData.chartData.map(
                  (
                    point,
                    index // Show all 12 for month view if possible
                  ) => (
                    <div
                      key={index}
                      className={`text-center ${
                        index % 2 !== 0 ? "hidden sm:block lg:block" : ""
                      }`}
                    >
                      {" "}
              ...
              {timePeriod !== "month" &&
                currentData.chartData.map(
                  (
                    point,
                    index // Handle weekly labels differently if needed
                  ) => (
          ...
          <div className="space-y-3 sm:space-y-4 mb-8">
            ...
            {currentData.insights.map(
              (
                ...
                <div //
                  key={index} //
                  className={`relative p-3 sm:p-4 rounded-xl border-2 transition-all duration-300 hover:scale-105 cursor-pointer ${
                    // Adjusted padding
                    insight.type === "amber"
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    >
                      <i className={`${insight.icon} text-xs sm:text-sm`}></i>{" "}
                      {/* Adjusted size */}
                    </div>
                    <div className="flex-1">
