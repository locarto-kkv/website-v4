    ...
    return (
        <div className="space-y-6"> {/* Use space-y for consistent gap */} {/* */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> {/* */}
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow flex flex-col"> {/* Added flex flex-col */} {/* */}
                    <div className="flex items-center gap-3 mb-4"> {/* */}
                        ...
                        <h3 className="text-xl font-bold text-gray-900">Milestone Commissions</h3> {/* */}
                    </div>
                    <p className="text-gray-600 text-sm mb-4 flex-grow"> {/* Added flex-grow */} {/* */}
                        Reach sales milestones to automatically reduce your commission rates with this premium add-on. {/* */}
                    </p>

                    {/* Stats Area - Replacing the progress bar */}
                    <div className="space-y-2 mb-4"> {/* */}
                        <div className="flex justify-between text-sm p-2 bg-gray-50 rounded"> {/* */}
                            <span className="font-medium text-gray-700">Current Commission:</span> {/* */}
                            <span className="font-bold text-gray-800">{premiumStats.currentCommissionRate}</span> {/* */}
                        </div>
                        <div className="flex justify-between text-sm p-2 bg-gray-50 rounded"> {/* */}
                            <span className="font-medium text-gray-700">Next Milestone Target:</span> {/* */}
                            <span className="font-bold text-gray-800">{premiumStats.nextMilestoneTarget.toLocaleString()} Items Sold</span> {/* */}
                        </div>
