              ...
              <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                ...
                <div className="absolute top-0 right-0 mt-4 mr-4 sm:relative sm:mt-0 sm:mr-0">
                  <button //
                    ...
                    className="flex items-center gap-1.5 bg-white/40 hover:bg-white/60 backdrop-blur-sm border border-white/50 text-black py-2 px-4 rounded-lg font-semibold transition-all hover:shadow-md text-xs sm:text-sm" //
                  >
