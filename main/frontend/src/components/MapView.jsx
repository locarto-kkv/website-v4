      ...
      <div className="h-screen relative"> //
        ...
        {!showOverlay && ( //
          <>
            ...
            {/* *** MODIFIED LINE *** */}
            <div
              className="lg:hidden absolute left-4 right-4 z-[9999] bg-gray-900/80 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl p-3 flex items-center justify-between gap-3 animate-slide-up" //
              style={{ bottom: 'calc(1.25rem + env(safe-area-inset-bottom))' }} // 1.25rem is 'bottom-5' //
            >
            {/* *** END MODIFICATION *** */}
