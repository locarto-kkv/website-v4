...
const BrandIdentityCard = ({
  ...
  const calculateResponsiveStyles = useCallback((width) => { //
    ...
    if (width > 400) { // Example breakpoint for slightly larger
     ...
     if (width > 550) { // Example breakpoint for medium (within max-w-640px)
  ...
  return (
    <div className="mt-6 w-full flex flex-col items-center px-2"> {/* */}
     <div className="relative w-full max-w-[640px] brand-card-container"> {/* Reduced max-width significantly */} {/* */}
        {/* Border Frame */}
        <img
