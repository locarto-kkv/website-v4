        ...
        <div className="flex items-baseline gap-2 mt-3">
          ...
          {trend && (
            <div className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold ${
              ...
              <i className={`fas fa-arrow-${trend === 'up' ? 'up' : trend === 'down' ? 'down' : 'right'} text-xs`}></i>
              {trendValue}
            </div>
          )}
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Track your business performance at a glance</p>
        </div>
      ...
      <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { label: "View Orders", icon: "fas fa-list", color: "bg-green-500" },
            { label: "Analytics", icon: "fas fa-chart-bar", color: "bg-purple-500" },
