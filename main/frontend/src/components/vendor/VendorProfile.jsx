        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4 0V5a2 2 0 012-2h2a2 2 0 012 2v2m-4 0V5a2 2 0 012-2h2a2 2 0 012 2v2m-4 0V5a2 2 0 012-2h2a2 2 0 012 2v2"
                  />
                </svg>
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <button
                onClick={openSetup}
                className="w-full px-6 py-3 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-colors"
              >
                Complete Setup
              </button>
            </div>
